						...
						<section>
							...
							<div className="space-y-2 bg-zinc-900/50 p-2 rounded-xl border border-zinc-700">
								...
								<ResourceItem
									...
									usage={
										usage ? formatMemory(usage.requests?.memory) : undefined
									}
								...
								<ResourceItem
									...
									usage={
										usage ? formatStorage(usage.requests?.storage) : undefined
									}
						...
						<section>
							...
							<div className="space-y-2 bg-zinc-900/50 p-2 rounded-xl border border-zinc-700">
								...
								<ResourceItem
									...
									usage={
										usage ? formatStorage(usage.limits?.storage) : undefined
									}
									color="text-yellow-200"
								/>
							</div>
